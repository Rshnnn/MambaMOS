...
class Collect(object):
    ...
    def __call__(self, data_dict):
        ...
        if "structured_scans" in self.keys:
            data["structured_scans"] = torch.unsqueeze(data["structured_scans"], dim=0)
        return data
...
class SphereCrop(object):
    ...
    def __call__(self, data_dict):
        ...
        # mode is "random" or "center"
            ...
            if "tn" in data_dict.keys():
                data_dict["tn"] = data_dict["tn"][idx_crop]
        return data_dict
